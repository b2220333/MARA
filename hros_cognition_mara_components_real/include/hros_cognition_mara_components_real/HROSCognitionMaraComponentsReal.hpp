#ifndef HROSCOGNITIONSCARACOMPONETSREALNODE_H
#define HROSCOGNITIONSCARACOMPONETSREALNODE_H
...
class HROSCognitionMaraComponentsRealNode : public rclcpp::Node
{
  public:
   ...
   */
  explicit HROSCognitionMaraComponentsRealNode(const std::string & node_name,
...
#endif // HROSCOGNITIONSCARACOMPONETSREALNODE_H
