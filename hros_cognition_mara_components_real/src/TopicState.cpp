...
void HROSCognitionMaraComponentsRealNode::stateCallback(std::string motor_name, float velocity, float position, float effort)
{
...
void HROSCognitionMaraComponentsRealNode::timer_stateCommonPublisher()
{
